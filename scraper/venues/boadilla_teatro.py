...
async def scrape_boadilla_teatro():
    return await scrape_red_municipios(
        url="https://www.madrid.org/clas_artes/red/boadilla.html",
        venue_name="Teatro Municipal (Casa de Cultura)",
        municipality="Boadilla del Monte",
        venue_header_text="TEATRO MUNICIPAL (CASA DE CULTURA)"
    )

if __name__ == "__main__":
    res = asyncio.run(scrape_boadilla_teatro())
    for e in res:
