...
async def scrape_guadarrama():
    return await scrape_red_municipios(
        url="https://www.madrid.org/clas_artes/red/guadarrama.html",
        venue_name="Centro Cultural La Torre",
        municipality="Guadarrama"
    )

if __name__ == "__main__":
    res = asyncio.run(scrape_guadarrama())
    for e in res:
