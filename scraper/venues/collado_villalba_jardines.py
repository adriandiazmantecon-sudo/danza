...
async def scrape_collado_villalba_jardines():
    return await scrape_red_municipios(
        url="https://www.madrid.org/clas_artes/red/colladovillalba.html",
        venue_name="Jardines de Peñalba",
        municipality="Collado Villalba",
        venue_header_text="JARDINES DE PEÑALBA"
    )

if __name__ == "__main__":
    res = asyncio.run(scrape_collado_villalba_jardines())
    for e in res:
