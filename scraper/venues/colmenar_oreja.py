...
async def scrape_colmenar_oreja():
    return await scrape_red_municipios(
        url="https://www.madrid.org/clas_artes/red/colmenardeoreja.html",
        venue_name="Teatro Municipal Diéguez",
        municipality="Colmenar de Oreja"
    )

if __name__ == "__main__":
    res = asyncio.run(scrape_colmenar_oreja())
    for e in res:
