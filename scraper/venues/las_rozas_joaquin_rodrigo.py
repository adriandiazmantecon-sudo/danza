...
async def scrape_las_rozas_joaquin_rodrigo():
    return await scrape_red_municipios(
        url="https://www.madrid.org/clas_artes/red/lasrozas.html",
        venue_name="Auditorio Joaquín Rodrigo",
        municipality="Las Rozas de Madrid",
        venue_header_text="Auditorio Joaquín Rodrigo"
    )

if __name__ == "__main__":
    res = asyncio.run(scrape_las_rozas_joaquin_rodrigo())
    for e in res:
