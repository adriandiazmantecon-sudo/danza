...
async def scrape_manzanares_real():
    return await scrape_red_municipios(
        url="https://www.madrid.org/clas_artes/red/manzanaresreal.html",
        venue_name="Sala El Rodaje",
        municipality="Manzanares el Real"
    )

if __name__ == "__main__":
    res = asyncio.run(scrape_manzanares_real())
    for e in res:
